...
For open questions and discussions about the DH OER Champions programme, we invite you to [join our Slack](https://join.slack.com/t/dhcssza/shared_invite/zt-o3s8i5f7-JzA3rSdUNFMQM6BxXEnyxA) workspace and ask questions in the #champions-educator channel. For more information about the Slack workspace, please read our [blog post](https://escalator.sadilar.org/post/connect-with-the-community/).

You can also contact the following people directly via email:

- Prof Jako Olivier: [Jako.Olivier@nwu.ac.za](mailto:Jako.Olivier@nwu.ac.za)
- Anelda van der Walt: [escalator@talarify.co.za](mailto:)
